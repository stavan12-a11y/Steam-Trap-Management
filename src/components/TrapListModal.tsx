...
/** Shared trap list modal used by KPI tiles and chart drill-downs. */
export function TrapListModal({ open, onClose, title, description, traps }: TrapListModalProps) {
  return (
    <Modal
      open={open}
      onClose={onClose}
